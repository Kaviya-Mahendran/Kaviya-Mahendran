...
- **[Smart Food Safety System](https://github.com/Kaviya-Mahendran/smart-food-safety-system)** — ML + rule-based food safety decision-support prototype.
...
- **[Automated ETL Orchestration](https://github.com/Kaviya-Mahendran/automated-etl-orchestration)** — Python ETL workflow with validation, quality checks, loading and observability.
...
- **[Predictive Modelling Pipeline](https://github.com/Kaviya-Mahendran/predictive-modelling-pipeline)** — Reproducible classification workflow with model comparison and SHAP explainability.
